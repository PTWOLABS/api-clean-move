...
import { SecureConfirmationCodeGenerator } from "./secure-confirmation-code-generator";
...
@Module({
  ...
  providers: [
    ...
    {
      provide: ConfirmationCodeGenerator,
      useClass: SecureConfirmationCodeGenerator,
    },
  ],
  exports: [
    AuthService,
